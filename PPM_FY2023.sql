...
,final_PPM_FY23 as(
  ...
  Variacion_Raw_Material,
  Variation_X_Operation,
  coalesce(Variacion_Raw_Material,0)+coalesce(Variation_X_Operation,0) as Total_variation
